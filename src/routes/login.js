...
router.post('/login', validateSchema('contracts/auth/login.request.schema.json'), async (req, res, next) => {
  ...
  if (!domain) {
    console.error('A variável de ambiente AUTHN_DOMAIN deve estar configurada');
