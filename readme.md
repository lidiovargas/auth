...
- Biblioteca `schemas/` deve ser clonada do git, e ficar disponível um diretório antes ´../´
- Biblioteca `errors/` deve ser clonada do git, e ficar disponível um diretório antes ´../´
...
### 2. Para Desenvolvimento (Dia a dia)
